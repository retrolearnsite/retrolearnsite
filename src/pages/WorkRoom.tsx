                ...
                <Card className="border-2 border-primary/30 bg-card/40 backdrop-blur-xl shadow-neon">
                  <CardHeader className="border-b border-border/50">
                    <div className="flex items-center justify-between">
                      <CardTitle className="font-retro text-lg glow-text flex items-center gap-2">Live Chat    <MessageCircle className="w-5 h-5" />
                        LIVE CHAT
                      </CardTitle>
            ...
            <div className="space-y-4">
              ...
              duration: 0.2
                ...
                <Card className="border-2 border-accent/50 bg-card/95 backdrop-blur-sm shadow-neon cursor-pointer hover:border-accent transition-all" onClick={() => setAiDialogOpen(true)}>
                  <CardHeader>
                    <CardTitle className="font-retro text-xl glow-text flex items-center gap-2">Ai Study Buddy    <Brain className="w-5 h-5" />
                      AI STUDY BUDDY
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
