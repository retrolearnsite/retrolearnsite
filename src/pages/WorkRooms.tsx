        ...
        <motion.div initial={{
          ...
          opacity: 1
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {Array(6).fill(0).map((_, i) => <Skeleton key={i} className="h-56 rounded-lg animate-pulse" style={{
  ...
  return <div className="min-h-screen bg-background p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
        ...
        y: 0
          ...
          <Button variant="outline" size="sm" onClick={() => navigate('/')} className="font-retro glow-border hover:shadow-neon transition-all">
        ...
        delay: 0.3
          ...
          <div className="flex justify-center">
            ...
            title: "DISCOVER",
            icon: Globe
          }]} activeColor="text-primary" className="border-2 border-primary/30 bg-card/90 backdrop-blur-sm shadow-neon font-retro" onChange={index => {
            if (index === 0) setActiveTab('my-rooms');else if (index === 1) setActiveTab('discover');
          }} />
          </div>

          {/* My Rooms Tab */}
          {activeTab === 'my-rooms' && <div className="mt-8 space-y-6">
              {/* Actions */}
              <motion.div initial={{
            opacity: 0,
            scale: 0.95
            ...
            delay: 0.4
              ...
              {/* Rooms Grid */}
              {rooms.length === 0 ? <motion.div initial={{
            opacity: 0,
            scale: 0.9
          }} animate={{
            opacity: 1,
            ...
            delay: 0.5
              ...
              repeat: Infinity
                ...
                </motion.div> : <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Discover Tab */}
          {activeTab === 'discover' && <div className="mt-8">
              <DiscoverRooms />
            </div>}
        </motion.div>
